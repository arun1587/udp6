...
//int V6Send(Foo *f, char *psrc_ip, char *pdst_ip, char *pdst_mac, unsigned short esport, unsigned short lcport)
int V6Send(char *psrc_ip, char *pdst_ip, char *pdst_mac, unsigned short esport, unsigned short lcport, char hopLimit)
//int V6Send(struct cipv6 ciphdr, struct cudp cudphdr, char *pdst_mac)
{
	...
	//printf("SRC IP passed %s\n", psrc_ip);
	//printf("DST IP passed %s\n", pdst_ip);
	//printf("DST MAC passed %s\n", pdst_mac);
	//printf("FOO VALUE = %d\n",f->real);
	...
	*/
	...
	//iphdr.ip6_nxt = ciphdr.nextHeader;
	iphdr.ip6_nxt = IPPROTO_UDP;
	//iphdr.ip6_hops = ciphdr.hopLimit;
	iphdr.ip6_hops = hopLimit;
	...
	// UDP Header
	udphdr.source = htons(esport);
	udphdr.dest = htons(lcport);
